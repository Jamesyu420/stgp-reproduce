...
```text
Simulation/
├── simu_gaussian.py      # Main simulation workflow: data, fit, plot, or all
├── generation.py         # Synthetic count-data generator
├── benchmark_utils.py    # Wrappers for stGP and baseline methods
├── metrics_utils.py      # Recovery metrics and method alignment
├── plot_utils.py         # Figure helpers
├── SpatialPCA.py         # Local SpatialPCA implementation
└── results/simu1/        # Cached datasets and method results
```

Generated figures are written to:

```text
Figures/simu1_geneprogram_count/
```
